---
title: "How to Select and Use Models Across Providers in Inferoute"
sidebarTitle: "Models"
description: "Specify models by provider-prefixed name, short alias, or use 'auto' to let Inferoute select the best available model for your request."
---
