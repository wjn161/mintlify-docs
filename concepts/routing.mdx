---
title: "How Inferoute Intelligently Routes Your AI Requests"
sidebarTitle: "Routing"
description: "Inferoute's routing engine evaluates every request and selects the best provider based on your strategy — optimizing for cost, latency, or reliability."
---
...
Inferoute automatically retries failed requests on alternative providers. If the primary provider returns an error or times out, Inferoute selects the next best option according to your strategy and retries the request — without any additional code on your side.
