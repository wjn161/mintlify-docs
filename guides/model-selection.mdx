...
description: "Select models by provider-prefixed name, alias, or let Inferoute route automatically. Compare tiers and pick the right balance of quality, speed, and cost."
---
