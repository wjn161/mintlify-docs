---
title: "Make Your First Request with Inferoute"
sidebarTitle: "First Request"
description: "Send your first chat completion request through Inferoute's unified API and understand the response fields, provider routing, and common errors."
---
...
- Inferoute automatically retries with a backup provider when one is configured. See [Fallback Routing](/guides/fallback-routing) to set this up.
