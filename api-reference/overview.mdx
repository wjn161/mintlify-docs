---
title: "Inferoute REST API Reference"
sidebarTitle: "Overview"
description: "Complete reference for the Inferoute REST API. Route LLM requests across providers using an OpenAI-compatible interface at https://api.inferoute.ai/v1."
---
