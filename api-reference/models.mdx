...
title: "GET /v1/models"
sidebarTitle: "Models"
description: "List all available models on Inferoute. Returns model IDs, provider, context window, and capabilities. Use model IDs in your chat and completion requests."
---
