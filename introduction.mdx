---
title: "What is TokenHub?"
sidebarTitle: "Introduction"
description: "TokenHub is an OpenAI-compatible AI inference router that connects your app to every major LLM provider through a single API endpoint."
---
...
TokenHub routes each request based on the criteria you care about most: lowest cost, lowest latency, or highest availability. When a provider is degraded or rate-limiting you, TokenHub automatically retries with a configured fallback so your application stays responsive.

## Who it's for

TokenHub is designed for developers and teams building AI-powered applications who want to:
