---
title: "Manage Inferoute API Keys"
sidebarTitle: "API Keys"
description: "Create, rotate, and revoke Inferoute API keys from the dashboard. Set expiration dates, restrict keys to specific models, and isolate access by environment."
---
