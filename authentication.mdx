---
title: "Authenticate with Inferoute"
description: "Inferoute authenticates requests with API keys passed as Bearer tokens. Learn how to generate a key, pass it in requests, and follow security best practices."
---
